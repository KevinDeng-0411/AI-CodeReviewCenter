...
| RAG 召回 | 查询改写 + 结构分块 + pgvector cosine + BM25 + RRF | C4 已完成：ParadeDB pg_search 真 BM25（default tokenizer）替换 pg_trgm，三路门禁全过，中文精确 R@5 0.0→0.25，fused MRR 0.906→0.934，稀有标识符 MRR 1.000 |
